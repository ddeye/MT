...
<p align="justify">&emsp;&emsp;&ensp;W czasie post pandemicznym ze zwykłego zainteresowania oraz dla celów prezentaycjnych wykonałem <i>Pulpit nawigacyjny</i>. Projekt korzysta z rządowych danych <u>gov.pl</u> oraz <u>GUS.pl</u> (główny urząd statystyczny). Ze względu na ogromną liczbe danych został oparty na silniku ETL - Power Query. Dashboard  składa się z wielu elementów wizaulizayjnych min. pasków postępu, wykresów niernikowych, słupkowych czy map, które przedstawiają informację dotyczących zarażenia i zaszczepienia z perspektywy całego kraju lub poszczególnych województw. <i>Pulpi nawigayjny</i>dzięki wyposażeniu w elementy dynamiczne zmienia swoje wartości automatycznie do wyboru użytkownika. Z perspektywy projektu najważnijesze wskaźniki KPI zostały umieszczone w lewej, górnej cześci pulpitu. Dasboard został wyposażony w wykres kombi  </p>
